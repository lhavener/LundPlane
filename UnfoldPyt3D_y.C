void UnfoldClosure(std::string file, std::string var, std::string sd, std::string date, int x1, int x2, int y1, int y2)
{
  ...
  h1_uf_i2->Sumw2();
  h1_uf_i2->Scale(1./h1_norm->Integral(y1, y2), "width");
  ...
  h1_uf_i3->Sumw2();
  h1_uf_i3->Scale(1./h1_norm->Integral(y1, y2), "width");
  ...
  h1_uf_i4->Sumw2();
  h1_uf_i4->Scale(1./h1_norm->Integral(y1, y2), "width");
  ...
  h1_uf_i5->Sumw2();
  h1_uf_i5->Scale(1./h1_norm->Integral(y1, y2), "width");
  ...
  h1_uf_i6->Sumw2();
  h1_uf_i6->Scale(1./h1_norm->Integral(y1, y2), "width");
  ...
  h1_uf_i7->Sumw2();
  h1_uf_i7->Scale(1./h1_norm->Integral(y1, y2), "width");
  ...
  h1_uf_i8->Sumw2();
  h1_uf_i8->Scale(1./h1_norm->Integral(y1, y2), "width");
  ...
  h1_uf_i9->Sumw2();
  h1_uf_i9->Scale(1./h1_norm->Integral(y1, y2), "width");
  ...
  h1_uf_i7->SetLineColor(kOrange-3);
  h1_uf_i7->SetMarkerColor(kOrange-3);
  h1_uf_i7->SetMarkerStyle(20);
  h1_uf_i7->SetMarkerSize(1);
  h1_uf_i7->Draw("same");
  leg2->AddEntry(h1_uf_i7, "i = 7");
  h1_uf_i9->SetLineColor(kViolet);
  h1_uf_i9->SetMarkerColor(kViolet);
  ...
  std::stringstream ss;
  ss << "figures/PytCompy_" << x1 << "to" << x2 << "_dR" << y1 << "to" << y2 << "_" << sd << "_" << date << ".pdf";
