void UnfoldClosure(std::string file, std::string var, std::string sd, std::string date, int x1, int x2, int y1, int y2)
{
  ...
  h1_true->Sumw2();
  h1_true->Scale(1./h1_true->Integral(2,5), "width");
  ...
  h1_uf_i1->Sumw2();
  h1_uf_i1->Scale(1./h1_uf_i1->Integral(2,5), "width");
  ...
  h1_uf_i2->Sumw2();
  h1_uf_i2->Scale(1./h1_uf_i2->Integral(2,5), "width");
  ...
  h1_uf_i3->Sumw2();
  h1_uf_i3->Scale(1./h1_uf_i3->Integral(2,5), "width");
  ...
  h1_uf_i4->Sumw2();
  h1_uf_i4->Scale(1./h1_uf_i4->Integral(2,5), "width");
  ...
  h1_uf_i5->Sumw2();
  h1_uf_i5->Scale(1./h1_uf_i5->Integral(2,5), "width");
  ...
  h1_uf_i6->Sumw2();
  h1_uf_i6->Scale(1./h1_uf_i6->Integral(2,5), "width");
  ...
  h1_uf_i7->Sumw2();
  h1_uf_i7->Scale(1./h1_uf_i7->Integral(2,5), "width");
  ...
  h1_uf_i8->Sumw2();
  h1_uf_i8->Scale(1./h1_uf_i8->Integral(2,5), "width");
  ...
  h1_uf_i9->Sumw2();
  h1_uf_i9->Scale(1./h1_uf_i9->Integral(2,5), "width");
  ...
  leg->Draw("same");
  leg2->Draw("same");
  //lat->DrawLatex(0.93, 0.88, "60 < #it{p}_{T} < 80 GeV/c");
