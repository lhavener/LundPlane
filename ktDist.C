void ktDist_UF(std::string file_data, std::string date, int pt1, int pt2, int y1, int y2, bool ifpp, float max)
{
  std::stringstream ss;
  ...
  TH1D* h1_herwig = (TH1D*)f_data->Get("h1_herwig");
  //  h1_mc->SetName("h1_mc");                                                                                                                                             
  ss.str("");
  TH1D* h1_sherpa = (TH1D*)f_data->Get("h1_sherpa");
 
  //  h1_mc->SetName("h1_mc");

  TH1D* h1_sherpaL = (TH1D*)f_data->Get("h1_sherpaL");
  ss.str("");
...
ss << "h_ratio_one";
  ...
  h1_data->SetTitle("");
  h1_data->GetXaxis()->SetRangeUser(-1, 1.5);
  ...
  h1_mc->Draw("same");
  h1_herwig->SetLineColor(600-6);
  h1_herwig->SetMarkerColor(600-6);
  h1_herwig->SetMarkerStyle(33);
  h1_herwig->SetMarkerSize(1.6);
  h1_herwig->Draw("same");
  h1_sherpa->SetLineColor(kGreen-2);
  h1_sherpa->SetMarkerColor(kGreen-2);
  h1_sherpa->SetMarkerStyle(34);
  h1_sherpa->SetMarkerSize(1.2);
  h1_sherpa->Draw("same");
  h1_sherpaL->SetLineColor(kViolet);
  h1_sherpaL->SetMarkerColor(kViolet);
  h1_sherpaL->SetMarkerStyle(29);
  h1_sherpaL->SetMarkerSize(1.6);
  h1_sherpaL->Draw("same");
  std::cout << "1" << std::endl;
  ...
  leg->AddEntry(h1_herwig, "Herwig 7");
  leg->AddEntry(h1_sherpa, "Sherpa (AHADIC)");
  leg->AddEntry(h1_sherpaL, "Sherpa (Lund)");
  ...
  else if ((pt1 == 2) && (pt2 == 2)) lat->DrawLatex(0.92, 0.66, "20 < #it{p}_{T, ch jet} < 40 GeV/#it{c}");
  ...
  ss.str("");
  if (y2 == 7) ss << "0.1";
  else if (y2 == 2) ss << "0.27";
  else if (y2 == 6) ss << "0.12";
  ss << " < #Delta#it{R} < ";
    if (y1 == 1) ss << "0.4";
  else if (y1 == 2) ss << "0.33";
  else if (y1 == 5) ss << "0.12";
  else if (y1 == 6) ss << "0.15";
  ...
  lat2->DrawLatex(-0.92, 2.32, "0.4");
  //  lat2->DrawLatex(0.13 ,3.1, "0.35");                                                                                                         
  lat2->DrawLatex(-0.35, 2.32, "0.7");
  lat2->DrawLatex(0., 2.32, "1.0");
  lat2->DrawLatex(0.4, 2.32, "1.5");
  lat2->DrawLatex(1.1, 2.32, "3.0");
  lat2->DrawLatex(1.5, 2.32, "4.5");
  //  lat2->DrawLatex(0.87, 0.9, "50");                                                                                                           \
                                                                                                                                                   

  lat2->DrawLatex(1.1, 2.52, "#it{k}_{T} (GeV/#it{c})");
  ...
  h1_ratio->GetXaxis()->SetTitle("ln(#it{k}_{T}/GeV)");
  h1_ratio->GetXaxis()->SetRangeUser(-1, 1.5);
  h1_ratio->SetTitle("");
  ...
  g_her_ratio->SetMarkerStyle(34);
  g_her_ratio->SetMarkerSize(1.2);
  ...
  g_she_ratio->SetMarkerStyle(29);
  g_she_ratio->SetMarkerSize(1.6);
  ...
  p2->Draw();
    ...
    ss << "figures/lnktDist_" << pt1 << "to" << pt2 << "_" << y1 << "to" << y2;
  ss << "_" << date << ".pdf";
