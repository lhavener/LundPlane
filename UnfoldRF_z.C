void UnfoldIter(std::string file, std::string sd, std::string date, int x1, int x2, int y1, int y2)
{
  ...
  TH3D* h2_true = (TH3D*)f->Get("h3_raw_corr");
  TH3D* h2_eff = (TH3D*)f->Get("true_match");
  //   h2_eff->Divide(h2_true);
  TH1D* h1_true = (TH1D*)h2_true->ProjectionZ("h1_true", x1, x2, y1, y2);
  h1_true->Sumw2();
  h1_true->Scale(1./h1_true->Integral(), "width");
  TH3D* h2_uf_i1 = (TH3D*)f->Get("Bayesian_Foldediter1");
  //  h2_uf_i1->Divide(h2_eff);
  TH1D* h1_uf_i1 = (TH1D*)h2_uf_i1->ProjectionZ("h1_uf_i1", x1, x2, y1, y2);
  h1_uf_i1->Sumw2();
  h1_uf_i1->Scale(1./h1_uf_i1->Integral(), "width");
  TH3D* h2_uf_i2 = (TH3D*)f->Get("Bayesian_Foldediter2");
  //  h2_uf_i2->Divide(h2_eff);
  TH1D* h1_uf_i2 = (TH1D*)h2_uf_i2->ProjectionZ("h1_uf_i2", x1, x2, y1, y2);
  h1_uf_i2->Sumw2();
  h1_uf_i2->Scale(1./h1_uf_i2->Integral(), "width");
  TH3D* h2_uf_i3 = (TH3D*)f->Get("Bayesian_Foldediter3");
  //  h2_uf_i3->Divide(h2_eff);
  TH1D* h1_uf_i3 = (TH1D*)h2_uf_i3->ProjectionZ("h1_uf_i3", x1, x2, y1, y2);
  h1_uf_i3->Sumw2();
  h1_uf_i3->Scale(1./h1_uf_i3->Integral(), "width");
  TH3D* h2_uf_i4 = (TH3D*)f->Get("Bayesian_Foldediter4");
  //  h2_uf_i4->Divide(h2_eff);
  TH1D* h1_uf_i4 = (TH1D*)h2_uf_i4->ProjectionZ("h1_uf_i4", x1, x2, y1, y2);
  h1_uf_i4->Sumw2();
  h1_uf_i4->Scale(1./h1_uf_i4->Integral(), "width");
  TH3D* h2_uf_i5 = (TH3D*)f->Get("Bayesian_Foldediter5");
  //  h2_uf_i5->Divide(h2_eff);
  TH1D* h1_uf_i5 = (TH1D*)h2_uf_i5->ProjectionZ("h1_uf_i5", x1, x2, y1, y2);
  h1_uf_i5->Sumw2();
  h1_uf_i5->Scale(1./h1_uf_i5->Integral(), "width");
  TH3D* h2_uf_i6 = (TH3D*)f->Get("Bayesian_Foldediter6");
  //  h2_uf_i6->Divide(h2_eff);
  TH1D* h1_uf_i6 = (TH1D*)h2_uf_i6->ProjectionZ("h1_uf_i6", x1, x2, y1, y2);
  h1_uf_i6->Sumw2();
  h1_uf_i6->Scale(1./h1_uf_i6->Integral(), "width");
  TH3D* h2_uf_i7 = (TH3D*)f->Get("Bayesian_Foldediter7");
  //  h2_uf_i7->Divide(h2_eff);
  TH1D* h1_uf_i7 = (TH1D*)h2_uf_i7->ProjectionZ("h1_uf_i7", x1, x2, y1, y2);
  h1_uf_i7->Sumw2();
  h1_uf_i7->Scale(1./h1_uf_i7->Integral(), "width");
  TH3D* h2_uf_i8 = (TH3D*)f->Get("Bayesian_Foldediter8");
  //  h2_uf_i8->Divide(h2_eff);
  TH1D* h1_uf_i8 = (TH1D*)h2_uf_i8->ProjectionZ("h1_uf_i8", x1, x2, y1, y2);
  h1_uf_i8->Sumw2();
  h1_uf_i8->Scale(1./h1_uf_i8->Integral(), "width");
  TH3D* h2_uf_i9 = (TH3D*)f->Get("Bayesian_Foldediter9");
  //  h2_uf_i9->Divide(h2_eff);
  TH1D* h1_uf_i9 = (TH1D*)h2_uf_i9->ProjectionZ("h1_uf_i9", x1, x2, y1, y2);
  h1_uf_i9->Sumw2();
  ...
  h1_true->GetXaxis()->SetTitle("#it{p}_{T}");
  h1_true->GetYaxis()->SetTitle("#frac{1}{N_{jet}}#frac{dN}{d#it{p}_{T}}");
  h1_true->SetTitle("");
  h1_true->SetMaximum(h1_true->GetMaximum()*2);
  h1_true->SetMarkerStyle(20);
  h1_true->SetMarkerSize(1);
  h1_true->Draw();
  leg->AddEntry(h1_true, "Data");
  ...
  h1_i3toi1->SetTitle("Ratio folded to data");
  h1_i3toi1->GetXaxis()->SetTitle("#it{p}_{T}");
  h1_i3toi1->GetYaxis()->SetTitle("Ratio to data");
  h1_i3toi1->Draw();
  ...
  std::stringstream ss;
  ss << "figures/Folded3Dz_" << x1 << "to" << x2 << "_"<< y1 << "to" << y2 << "_" << sd << "_" << date << ".pdf";
